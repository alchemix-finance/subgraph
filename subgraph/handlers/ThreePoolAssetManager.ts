...
import {
  ...
  ThreePoolAssetManagerMintMetaPoolTokenEvent,
  ThreePoolAssetManagerMintMetaPoolTokensEvent,
  ThreePoolAssetManagerMintThreePoolTokenEvent,
...
export function handleMintThreePoolToken(event: MintThreePoolTokens1): void {
  const entity = createThreePoolAssetManagerEvent<ThreePoolAssetManagerMintThreePoolTokenEvent>(event);
...
export function handleMintMetaPoolToken(event: MintMetaPoolTokens1): void {
  const entity = createThreePoolAssetManagerEvent<ThreePoolAssetManagerMintMetaPoolTokenEvent>(event);
  entity.asset = event.params.asset;
  entity.amount = event.params.amount;
